/****
    ...
    Gw ID        : G42957795
    Approach :  1) generate particles limited in room
                2) update position and velocity
                    a) calculate force (gravity)
                        - by acceleration y = -9.8
                    b) calculate collision with wall
                        - by reflection
                    c) calculate collision with particles
                        - by conservation of momentum
                3) render the final matrix
    General Flow : iniPSystem() -> glutMainLoop()<-> updateParticle()
